...
커밍아웃을 하는 것은 본인 선택이며, 반드시 모든 사람에게 한 번에 커밍아웃을 할 필요도 없다는 점을 기억해 주세요. 누구에게 할지, 언제 할지 본인이 선택할 수 있고, 어떤 사람들에게는 커밍아웃 하지 않도록 결정할 수도 있습니다. 선택은 전적으로 본인에게 달려 있으며, Trevor는 당신이 어떤 결정을 하든 당신을 지지합니다.
